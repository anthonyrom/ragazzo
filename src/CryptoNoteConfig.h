...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7192; // addresses start with "RZ"
...
const char     CRYPTONOTE_NAME[]                             = "ragazzo";
